...
export const Footer = () => {
  return (
    <footer class="bg-gray-900 dark:text-[#fdfef9]">
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="flex justify-center text-teal-300 sm:justify-start">
          <Popcorn size={30} />
          <span class="ml-3 text-lg font-bold">Cinema</span>
        </div>

        <p
          class="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left"
        >
          Explore the best in cinema with our convenient online movie booking platform.
        </p>
        ...
        <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
          ...
          <li>
            <a
              href="https://github.com/Dohoangtrong"
              rel="noopener noreferrer"
              target="_blank"
              class="text-teal-500 transition hover:text-teal-500/75"
            >
          ...
          <ul class="mt-8 space-y-4 text-sm">
            ...
            >
              ...
              <address class="-mt-0.5 not-italic text-white">
                10 Nguyen Van Troi, Ha Dong, Ha Noi
              </address>
            </li>
          </ul>
        </div>
